...
const _checkpoint_doc = new GoogleSpreadsheet(process.env.GOOGLE_SHEET_CHECKPOINT!, serviceAccountAuth);
const _checkpoint_sheet_id = parseInt(process.env.GOOGLE_SHEET_CHECKPOINT_SHEET_ID!);
...
const getCheckpointSheet: () => Promise<GoogleSpreadsheetWorksheet> = async () => {
    await _checkpoint_doc.loadInfo();
    return _checkpoint_doc.sheetsById[_checkpoint_sheet_id];
}

export { getIssueSheet, getRegistrantSheets, getCheckpointSheet };